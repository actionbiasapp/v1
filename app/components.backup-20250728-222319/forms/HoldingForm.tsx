  ...
  return (
    <div className="bg-slate-800 rounded-lg p-4 border border-slate-600 mb-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-end gap-3">
          ...
          <div className="w-8">
            ...
            <button
              ...
              className="w-8 h-10 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-xs"
        ...
        {/* Buy Price, Current Price, and Profit/Loss - Third row, 3 columns */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div>
            ...
            <input
              type="number"
              placeholder="Enter buy price per unit"
          ...
          <div>
            ...
            <div className="w-full bg-slate-700 border border-slate-600 rounded px-3 py-2 text-sm min-h-[40px] flex items-center">
              {showProfitLoss ? (
